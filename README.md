...
3. Add it as an env variable for local development:
   ...
   - Add: `VITE_CARD_DEC_BLOB=< your decryption blob JSON >
4. Start your card locally (e.g. `npm run dev`).
5. Add the card to a dome (it will initially appear blank).
6. Click the **info (i)** icon next to the card name.
7. Open **Settings** → **Developer** section.
8. Set:
   - **Environment**: `Local`
